defmodule ElixirPracticeWeb.Errors do
  @moduledoc false
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(ElixirPractice.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(ElixirPractice.Gettext, "errors", message, options)
    end
  end
