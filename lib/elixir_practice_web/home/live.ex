defmodule ElixirPracticeWeb.Home.Live do
  @moduledoc false
  use Phoenix.LiveView, layout: {ElixirPracticeWeb.Layouts, :live}
  ...
  def render(assigns), do: ElixirPracticeWeb.Home.HTML.index_live(assigns)
