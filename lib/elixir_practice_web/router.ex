defmodule ElixirPracticeWeb.Router do
  ...
  pipeline :browser do
    ...
    plug(:put_layout, {ElixirPracticeWeb.Layouts, :app})
    plug(:put_root_layout, {ElixirPracticeWeb.Layouts, :root})
  end
  ...
  defp session(conn, _opts) do
    opts = Plug.Session.init(ElixirPracticeWeb.Session.config())
