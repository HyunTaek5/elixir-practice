defmodule ElixirPractice.TelemetryUI do
  @moduledoc false
  ...
  defp ecto_metrics do
    ...
    [
      average("elixir_practice.repo.query.total_time",
        description: "Database query total time",
        keep: ecto_keep,
        unit: {:native, :millisecond},
        ui_options: [class: "col-span-3", unit: " ms"]
      ),
      average_over_time("elixir_practice.repo.query.total_time",
  ...
  defp share_key, do: Application.get_env(:elixir_practice, __MODULE__)[:share_key]
end
