...
if get_env("PHX_SERVER", :boolean) == true do
  config :elixir_practice, ElixirPracticeWeb.Endpoint, server: true
end
...
config :elixir_practice, Corsica, origins: get_env("CORS_ALLOWED_ORIGINS", :cors)
...
config :elixir_practice, ElixirPractice.TelemetryUI, share_key: get_env("TELEMETRY_UI_SHARE_KEY")
